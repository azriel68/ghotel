...
entete("Sélectionner la catégorie",'popup');
...
echo "<br /><h1>Liste des catégories</h1>";

//requête
$sql = "SELECT id as 'ID',libelle as 'Libellé', tarif_defaut as 'prix' FROM hot_categorie WHERE id_hotel=".get_sess_hotel_id();
...
$lst->set_key('Libellé',$_REQUEST['p1']);
