<?php
/*
 * Classe permettant la création de tableau, lien ou image
...
/*
* associe une function js avec un evénement
*/
...
global $app;
	...
	if($opt=="rest60"){
		if($post_char=="rest60")$r.=$this->cell("<span class=\"lien_inactif\"><font color=red>(Fin valid à 60j)</font></span>");
		else $r.=$this->cell($this->link('(Fin valid à 60j)',$url.'&charIndex=rest60','lien'));
 ...
 * Ajout du paramétre de l'id de la table utile au cadre
 **/
