...
* Construteur
**/
function Tdb($db_type="mysql"){
        $this->type=$db_type;
        require("db_".$db_type.".conf");
        $this->db = &ADONewConnection($db_type);
        $this->db->NConnect($host, $usr, $pass, $db);
...
/**
* @Desc fonction  qui execute 1 requete SQL passée en paramètre
* @Param $query chaine de caractère contenant la requête à executer
* @Return TRUE si la fonction s'est bien executée  sinon le code d'erreur avec le message
**/
...
* @Param $pField nom du champ qui doit être retourné
* @Ret retourne la valeur du champ, faux si la fonction échoue
**/
