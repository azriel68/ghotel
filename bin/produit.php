...
function _fiche_regle(&$o, &$form){
	...
	$t->Cell(
		"Les règles d'insertions automatiques ".$t->link("ajouter","javascript:add_regle()","lien2","","ico_xplus.gif")
	,-1,'',2);
	$t->end_line();
	$t->beg_line();
	$t->beg_Cell(-1,'',2);
