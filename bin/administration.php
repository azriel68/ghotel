...
<?
  ...
  $t->Cell("Edition des confirmations de réservation du jour",300);
  $t->Cell(
  ...
  $t->Cell(
    $t->link($t->img('bt_impression.jpg', 'Imprimer les taxes de séjour du mois'),"javascript:taxe_sejour_mois()")
  );
	$t->end_line();
  ...
  $t->Cell(
	...
	$t->beg_line();
	  ...
	  $t->Cell("Arrivées sur période");
	  $t->Cell(
	    $t->link($t->img('bt_impression.jpg', 'Imprimer les arrivées'),"javascript:arrivees()")
	  );
		$t->end_line();
