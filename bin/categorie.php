<?
	...
	entete("Gestion catégories",'online');
...
function appliquer_prix(&$db, &$cat){
  ...
  info("Ces prix ont été appliqué sur les chambres de la catégorie");
}
...
function apply_prix(){
  if(window.confirm('Appliquer ces prix sur toutes les chambres de la catégorie ?')){
...
<?
  ...
  echo $form->hidden("p1", "");
	...
	$t->end_line();
	$t->beg_line();
	$t->Cell("Au delà de (strictement supérieur)");
