...
<head>
  ...
  <meta name="keywords" content="gestion, hôtel, hotel, camping, chambre, réservation, client" />
  <meta name="description" content="Ghotel - Logiciel de gestion hotellière" />
  <meta name="generator" content="Joomla! 1.5 - Open Source Content Management" />
  <title><?=$_TPL_VARS['titre']?> - GHôtel - GESTION HOTELLIERE - www.gestion-hotel.com</title>
<!-- SCRIPT GHOTEL -->
...
<div id="ja-headerwrap">
    ...
    if($_TPL_VARS['menu']=='online'){
      ...
      if($_TPL_VARS['have_rights']){
        ...
        print "<span style=\"color:red;\">Votre abonnement n'est plus valable depuis le ".$_TPL_VARS['dt_end_rights']." <a href=\"".get_right_link_add()."\">Cliquez ici pour vous réabonner</a></span>";
      }
    }
...
<div id="ja-mainnavwrap">
    ...
    if($_TPL_VARS['menu']=='online'){
      ?>
        <li><a href="../bin/main.php"><span>Mes hôtels</span></a></li>
        ...
        ?>
        <li><a href="../bin/reservation.php"><span>Les réservations</span></a></li>
          ...
          if(is_admin()){
              ?>
                ...
                <ul>
                  ...
                  <li><a href="../bin/categorie.php"><span>Les catégories de chambres</span></a></li>
                  <li><a href="../bin/utilisateur.php"><span>Les utilisateurs</span></a></li>
                  <li><a href="../bin/model.php"><span>Les modèles de documents</span></a></li>
                  <li><a href="../bin/param.php"><span>Les paramètres</span></a></li>
                  <li><a href="../bin/main.php?action=DECONNEXION"><span>Me déconnecter</span></a></li>
